About tikzmagic-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tikzmagic-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4992&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tikzmagic-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tikzmagic` can be installed with `conda`:
...
```
mamba install tikzmagic
```

It is possible to list all of the versions of `tikzmagic` available on your platform with `conda`:
...
```
mamba search tikzmagic --channel conda-forge
```
...
mamba repoquery search tikzmagic --channel conda-forge

# List packages depending on `tikzmagic`:
mamba repoquery whoneeds tikzmagic --channel conda-forge

# List dependencies of `tikzmagic`:
mamba repoquery depends tikzmagic --channel conda-forge
```
